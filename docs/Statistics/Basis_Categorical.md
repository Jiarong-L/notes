...
[Tschuproff / Pearson contingency coefficient](./Ecology/Contingency_coeff.png):  $\chi^2$ 被用于度量物种间的关联（基于0/1数据）  

更多Contingency Table 统计见 [Ecology](Ecology.md) Qualitative 
